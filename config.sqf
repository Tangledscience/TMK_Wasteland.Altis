...
[
	...
	["TERRITORY_CUSTOM1", "Military Base", 300, "MILITARY"],
	["TERRITORY_CUSTOM2", "Syrta", 300, "TOWN"],
	["TERRITORY_CUSTOM3", "Town", 300, "TOWN"],
	["TERRITORY_CUSTOM4", "Town", 300, "TOWN"],
	["TERRITORY_CUSTOM5", "Town", 300, "TOWN"],
	["TERRITORY_CUSTOM6", "Town", 300, "TOWN"],
	["TERRITORY_CUSTOM7", "Town", 300, "TOWN"],
	["TERRITORY_CUSTOM8", "Town", 300, "TOWN"],
	["TERRITORY_CUSTOM9", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM10", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM11", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM12", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM13", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM14", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM15", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM16", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM17", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM18", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM19", "Town", 300, "TOWN"],
    ["TERRITORY_CUSTOM20", "Town", 300, "TOWN"],
