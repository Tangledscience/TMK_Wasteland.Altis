...
A3W_objectLifetime = 0;         // Maximum lifetime in hours for saved objects (baseparts, crates, etc.) across server restarts (0 = no time limit)
...
// Loot settings
A3W_buildingLoot = 0;              // Spawn loot in all buildings (0 = no, 1 = yes)
